...
public interface IDrive {
    ...
    ESFileList children( ESFileId parentId, boolean addPermissions, int maxSize ) throws IOException;
    
    void downloadTo(ESFileId fileId,  OutputStream outputstream) throws IOException ;
    
    ESFileId insert(ESFileId parentId, InputStream in, String name, String description) throws IOException;
    ...
    ESFile getFile(ESFileId fileId, boolean addPermissions) throws IOException;

    void update(ESFileId fileId, InputStream in, String description) throws IOException;
